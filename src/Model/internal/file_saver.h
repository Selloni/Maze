...
namespace s21::internal {
         ...
         * s21::internal::FileSaver<s21::kMaze>::Save(data, "some/path/.txt")
         * s21::internal::FileSaver<s21::kCave>::Save(data, "some/path/.txt")
         *
         */
        template<FileTypes T> class FileSaver final {
         ...
         */
        template<> class FileSaver<kMaze> final {
            NON_CONSTRUCTABLE_CLASS(FileSaver)
         ...
         */
        template<> class FileSaver<kCave> final {
            NON_CONSTRUCTABLE_CLASS(FileSaver)
